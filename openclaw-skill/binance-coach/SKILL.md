...
metadata:
  {
    "openclaw":
      { "emoji": "📊", "requires": { "bins": ["python3", "pip3"], "env": ["BINANCE_API_KEY", "BINANCE_API_SECRET"] }, "primaryEnv": "BINANCE_API_KEY", "install": [{ "id": "python3", "kind": "brew", "formula": "python3", "bins": ["python3", "pip3"] }] },
  }
---
